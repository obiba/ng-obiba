...
//# sourceMappingURL=ng-obiba.js.map
/*
 * Copyright (c) 2018 OBiBa. All rights reserved.
 *
 * This program and the accompanying materials
...
angular.module('obiba.graphics', ['nvd3', 'obiba.utils'])
                ...
                chart: {
                    ...
                    tooltip: {
                        contentGenerator: function (o) {
                            ...
                            var s = '', bottom = '<span>' + series.key + ': <strong>' + series.value + '</strong></span>';
                            if (o.value) {
    ...
    function (ObibaCountriesGeoJson) {
        function ColorSelector(values, palette) {
            var sortedUniqueValues = values.filter(function (item, pos) {
        ...
        function lightestColor(colorArray) {
            ...
            return colorArray.reduce(function (acc, val) {
                ...
                var rgbVal = d3.rgb(val), rbgAcc = d3.rgb(acc);
...
obiba.utils.service('CountriesIsoUtils', ['$log', 'ObibaCountriesIsoCodes',
    ...
    .value('ObibaCountriesGeoJson', { 'type': 'FeatureCollection', 'features': [
        ...
        { 'type': 'Feature', 'properties': { 'name': 'French Guiana' }, 'geometry': { 'type': 'Polygon', 'coordinates': [[[-52.556425, 2.504705], [-52.939657, 2.124858], [-53.418465, 2.053389], [-53.554839, 2.334897], [-53.778521, 2.376703], [-54.088063, 2.105557], [-54.524754, 2.311849], [-54.27123, 2.738748], [-54.184284, 3.194172], [-54.011504, 3.62257], [-54.399542, 4.212611], [-54.478633, 4.896756], [-53.958045, 5.756548], [-53.618453, 5.646529], [-52.882141, 5.409851], [-51.823343, 4.565768], [-51.657797, 4.156232], [-52.249338, 3.241094], [-52.556425, 2.504705]]] }, 'id': 'GUF' },
...
obiba.utils.EventListenerRegistry = function () {
    var listeners = [];
...
//# sourceMappingURL=obiba-file-download.js.map
'use strict';
(function () {
    ...
    angular.module('ngObiba')
        .directive('obibaTableSorter', [function () {
            ...
            function obibaTableSorterComparator(a, b) {
                ...
                var stringA = resolveObjectPath(a, currentTarget), stringB = resolveObjectPath(b, currentTarget);
            ...
            function clearOtherButtonStates(excludedColumnName) {
                var selector = 'thead a:not([data-column-name=\'' + excludedColumnName + '\'])', otherButtons = obibaTableSorterState.element[0].querySelectorAll(selector);
                ...
                if (columns.length) {
                    for (var key in columns) {
                        if (columns.hasOwnProperty(key)) {
                            var columnElement = columns[key], button = createAndAppendSortButtonToColumnHeader(columnElement);
...
//# sourceMappingURL=obiba-table-sorter.js.map
