...
angular.module("obiba.graphics", [ "nvd3", "obiba.utils" ]).factory("D3GeoConfig", [ function() {
    ...
    function D3ChartConfig(aggregation) {
        ...
        if (options.chart.type === "pieChart") {
            ...
            options.chart.labelThreshold = .1;
...
} ]).directive("obibaGeo", [ "ObibaCountriesGeoJson", function(ObibaCountriesGeoJson) {
    function luma(rgbColor) {
        return rgbColor.r * .2126 + rgbColor.g * .7152 + rgbColor.b * .0722;
    }
    ...
    function ColorSelector(values, palette) {
        ...
        this.color = function(value) {
            ...
            return index === 0 ? d3.rgb(configColor) : d3.rgb(configColor).darker(index * .005 * value);
        };
    }
    function link(scope, element) {
        ...
        function renderMap(ratio) {
            ...
            var tooltip = d3.select(element[0]).append("div").attr("class", "hidden chart-tooltip");
            var projection = d3.geo.equirectangular().translate([ scope.config.getDimensions().width * ratio / 2, scope.config.getDimensions().height * ratio / 2 ]).scale(scope.config.getScale() * ratio);
            var path = d3.geo.path().projection(projection);
            var svg = d3.select(element[0]).append("svg").attr("width", scope.config.getDimensions().width * ratio).attr("height", scope.config.getDimensions().height * ratio);
            var g = svg.append("g");
            g.selectAll("path").data(ObibaCountriesGeoJson.features).enter().append("path").attr("d", path).style("fill", function(d) {
                return data[d.id] ? colorSelector.color(data[d.id]) : d3.rgb("#ccc");
            }).style("stroke", "#fff").on("mousemove", function(d) {
                ...
                tooltip.classed("hidden", false).attr("style", "left:" + (mouse[0] + 5) + "px; top:" + (mouse[1] - 5) + "px; position: absolute").html(tooltipText);
...
obiba.utils.service("CountriesIsoUtils", [ "$log", "ObibaCountriesIsoCodes", function($log, ObibaCountriesIsoCodes) {
...
} ]).service("StringUtils", obiba.utils.NgObibaStringUtils).filter("ellipsis", [ "StringUtils", function(StringUtils) {
    ...
    features: [ {
        ...
        geometry: {
            type: "Polygon",
            coordinates: [ [ [ 1.060122, 5.928837 ], [ -.507638, 5.343473 ], [ -1.063625, 5.000548 ], [ -1.964707, 4.710462 ], [ -2.856125, 4.994476 ], [ -2.810701, 5.389051 ], [ -3.24437, 6.250472 ], [ -2.983585, 7.379705 ], [ -2.56219, 8.219628 ], [ -2.827496, 9.642461 ], [ -2.963896, 10.395335 ], [ -2.940409, 10.96269 ], [ -1.203358, 11.009819 ], [ -.761576, 10.93693 ], [ -.438702, 11.098341 ], [ .023803, 11.018682 ], [ -.049785, 10.706918 ], [ .36758, 10.191213 ], [ .365901, 9.465004 ], [ .461192, 8.677223 ], [ .712029, 8.312465 ], [ .490957, 7.411744 ], [ .570384, 6.914359 ], [ .836931, 6.279979 ], [ 1.060122, 5.928837 ] ] ]
        },
        id: "GHA"
    }, {
        type: "Feature",
        ...
        geometry: {
            type: "Polygon",
30.74, -8.34 ], [ 30.2, -7.08 ], [ 29.62, -6.52 ], [ 29.419993, -5.939999 ], [ 29.519987, -5.419979 ], [ 29.339998, -4.499983 ], [ 29.753512, -4.452389 ], [ 30.11632, -4.09012 ], [ 30.50554, -3.56858 ], [ 30.75224, -3.35931 ], [ 30.74301, -3.03431 ], [ 30.52766, -2.80762 ], [ 30.46967, -2.41383 ], [ 30.758309, -2.28725 ], [ 30.816135, -1.698914 ], [ 30.419105, -1.134659 ], [ 30.76986, -1.01455 ], [ 31.86617, -1.02736 ], [ 33.903711, -.95 ] ] ]
        },
        id: "TZA"
    }, {
        type: "Feature",
        ...
        geometry: {
            type: "Polygon",
            coordinates: [ [ [ 31.86617, -1.02736 ], [ 30.76986, -1.01455 ], [ 30.419105, -1.134659 ], [ 29.821519, -1.443322 ], [ 29.579466, -1.341313 ], [ 29.587838, -.587406 ], [ 29.8195, -.2053 ], [ 29.875779, .59738 ], [ 30.086154, 1.062313 ], [ 30.468508, 1.583805 ], [ 30.85267, 1.849396 ], [ 31.174149, 2.204465 ], [ 30.77332, 2.33989 ], [ 30.83385, 3.50917 ], [ 31.24556, 3.7819 ], [ 31.88145, 3.55827 ], [ 32.68642, 3.79232 ], [ 33.39, 3.79 ], [ 34.005, 4.249885 ], [ 34.47913, 3.5556 ], [ 34.59607, 3.05374 ], [ 35.03599, 1.90584 ], [ 34.6721, 1.17694 ], [ 34.18, .515 ], [ 33.893569, .109814 ], [ 33.903711, -.95 ], [ 31.86617, -1.02736 ] ] ]
        },
        id: "UGA"
    }, {
        type: "Feature",
...
angular.module("obiba.notification", [ "templates-main", "pascalprecht.translate", "ui.bootstrap" ]);

"use strict";

angular.module("obiba.notification").constant("NOTIFICATION_EVENTS", {
...
}).controller("NotificationController", [ "$rootScope", "$scope", "$uibModal", "NOTIFICATION_EVENTS", function($rootScope, $scope, $uibModal, NOTIFICATION_EVENTS) {
...
} ]).controller("NotificationModalController", [ "$scope", "$uibModalInstance", "notification", function($scope, $uibModalInstance, notification) {
...
} ]).controller("NotificationConfirmationController", [ "$scope", "$uibModalInstance", "confirm", "LocaleStringUtils", function($scope, $uibModalInstance, confirm, LocaleStringUtils) {
    function getMessage() {
        return {
...
angular.module("obiba.rest", [ "obiba.notification" ]).config([ "$httpProvider", function($httpProvider) {
    $httpProvider.interceptors.push("httpErrorsInterceptor");
} ]).factory("httpErrorsInterceptor", [ "$q", "$rootScope", "NOTIFICATION_EVENTS", "ServerErrorUtils", function($q, $rootScope, NOTIFICATION_EVENTS, ServerErrorUtils) {
...
angular.module("obiba.form", [ "obiba.utils", "obiba.notification", "templates-main" ]);

"use strict";

angular.module("obiba.form").service("FormServerValidation", [ "$rootScope", "$log", "StringUtils", "ServerErrorUtils", "NOTIFICATION_EVENTS", function($rootScope, $log, StringUtils, ServerErrorUtils, NOTIFICATION_EVENTS) {
...
angular.module("obiba.form").directive("formServerError", [ function() {
    return {
        restrict: "A",
        require: "?ngModel",
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.$watch("model", function(selected) {
                ...
                $scope.items = $scope.options.map(function(n) {
                    var value = angular.isArray(selected) && (selected.indexOf(n) > -1 || selected.indexOf(n.name) > -1);
                    return {
            ...
            $scope.$watch("items", function(items) {
                if (items && angular.isArray(items)) {
                    $scope.model = items.filter(function(e) {
                        return e.value;
                    }).map(function(e) {
                        return e.name.replace(attrs.model + ".", "");
                    });
                }
            }, true);
            $scope.$watch("options", function(opts) {
                ...
                $scope.items = opts.map(function(n) {
                    var value = angular.isArray($scope.model) && ($scope.model.indexOf(n) > -1 || $scope.model.indexOf(n.name) > -1);
                    return {
                        name: attrs.model + "." + (n.name || n),
                        label: n.label || n,
                        value: value
    ...
    return {
        ...
        link: function($scope) {
            ...
            $scope.formatList = function(item) {
                return $scope.autoComplete.format.replace(":label", item[$scope.autoComplete.label]).replace(":value", item[$scope.autoComplete.value]);
            };
...
angular.module("obiba.alert", [ "templates-main", "pascalprecht.translate", "ui.bootstrap", "ngSanitize" ]).config([ "$provide", function($provide) {
    $provide.provider("AlertBuilder", function() {
        ...
        this.$get = [ "AlertService", "ServerErrorUtils", "LocaleStringUtils", function(AlertService, ServerErrorUtils, LocaleStringUtils) {
...
angular.module("obiba.alert").constant("ALERT_EVENTS", {
    showAlert: "event:show-alert"
}).service("AlertService", [ "$rootScope", "$log", "LocaleStringUtils", "ALERT_EVENTS", function($rootScope, $log, LocaleStringUtils, ALERT_EVENTS) {
...
angular.module("obiba.alert").directive("obibaAlert", [ "$rootScope", "$timeout", "$log", "ALERT_EVENTS", function($rootScope, $timeout, $log, ALERT_EVENTS) {
    return {
        restrict: "AE",
        scope: {
            id: "@"
...
angular.module("obiba.comments", [ "obiba.utils", "obiba.notification", "obiba.form", "templates-main", "pascalprecht.translate", "angularMoment" ]);

"use strict";

angular.module("obiba.comments").config([ "markedProvider", function(markedProvider) {
...
} ]).controller("ObibaCommentEditorController", [ "$scope", function($scope) {
    var reset = function() {
        $scope.comment = {
            message: null
        };
...
} ]).controller("ObibaCommentsController", [ "$scope", "moment", function($scope, moment) {
            ...
            $scope.comments.$promise.then(function(comments) {
                return comments.map(function(comment) {
                    if (comment.modifiedBy) {
                        comment.modifierFullName = $scope.nameResolver({
                            profile: comment.modifiedByProfile
                        });
                        comment.modifiedOn = fromNow(comment.timestamps.lastUpdate);
                    } else {
                        comment.creatorFullName = $scope.nameResolver({
                            profile: comment.createdByProfile
                        });
...
(function() {
    angular.module("ngObiba").directive("obibaFileDownload", function() {
        return {
            restrict: "A",
            replace: true,
            scope: {
